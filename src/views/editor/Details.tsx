...
import { Field, Modal, Segmented, Toggle, inputClass } from "../../components/ui";
...
export function Details({
  ...
  return (
    <Modal open={open} onClose={onClose} title="Document details" wide>
      ...
      {mcqIssues.length > 0 && (
        <div className="mt-5 space-y-1.5 rounded-xl border border-edge bg-raised p-4">
